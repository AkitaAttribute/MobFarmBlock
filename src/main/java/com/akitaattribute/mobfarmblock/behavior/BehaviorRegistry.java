...
public final class BehaviorRegistry {
    ...
    public static void registerDefaults() {
        register(ResourceLocation.withDefaultNamespace("sheep"), new SheepBehavior());
        register(ResourceLocation.withDefaultNamespace("cow"), new CowBehavior());
        register(ResourceLocation.withDefaultNamespace("mooshroom"), new CowBehavior());
        register(ResourceLocation.withDefaultNamespace("chicken"), new ChickenBehavior());
    }
