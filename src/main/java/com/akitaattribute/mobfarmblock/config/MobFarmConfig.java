...
public final class MobFarmConfig {
    ...
    static {
        ...
        DEBUG_CHAT_MESSAGES = commonBuilder
        ...
        DEBUG_COBBLEMON_JSON_DUMP = commonBuilder
        ...
        PIXELMON_ENTITY_TRACKING_LOG = commonBuilder
        ...
        PIXELMON_NPC_REMOVAL_ENABLED = commonBuilder
        ...
        PIXELMON_PEN_IDLE_ANIMATION = clientBuilder
                ...
                .define("pixelmonPenIdleAnimation", true);
