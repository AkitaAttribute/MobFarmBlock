...
/** Optional integration scaffold; it never links Cobblemon classes unless a future implementation can do so safely. */
public final class CobblemonIntegration {
    ...
    public static boolean isPokemonEntity(Entity entity) { return isLoaded() && entity.getType().builtInRegistryHolder().key().location().getNamespace().equals("cobblemon"); }
